...
export const T = {
  ...
  swapDrawer: {
    ...
    sellConfirmTitle: { en: 'Confirm Sale',                   zh: '确认出售' },
    sellConfirmMsg:   { en: (name, amt) => `Sell ${name} for $${amt}M?`,    zh: (name, amt) => `以 $${amt}M 出售 ${name}？` },
    sellRefund:       { en: (amt) => `You receive $${amt}M (80% of salary)`, zh: (amt) => `返还 $${amt}M（薪资的 80%）` },
    sellYes:          { en: 'Confirm Sell',                   zh: '确认出售' },
    sellCancel:       { en: 'Cancel',                         zh: '取消' },
  ...
  slotMachine: {
    ...
    subtitle:      { en: 'Spin to sign a 2025 rookie · duplicates allowed', zh: '抽取2025新秀球员 · 可重复签约' },
    spinBtn:       { en: '🎴 Spin  $5M',                              zh: '🎴 抽签  $5M' },
    spinCost:      { en: '$5M per spin · best picks are rarest',      zh: '每次 $5M · 顺位越高越难抽' },
    capLeft:       { en: 'Cap Left',                                  zh: '薪资空间' },
    spinAgain:     { en: 'Spin Again',                                zh: '再次抽签' },
    gotPlayer:     { en: 'Signed',                                    zh: '成功签约' },
    signPrompt:    { en: 'Sign this rookie?',                         zh: '签约这名新秀？' },
    signBtn:       { en: (sal) => `✅ Sign  $${sal}M cap`,           zh: (sal) => `✅ 签约  占 $${sal}M 薪资` },
    passBtn:       { en: 'Pass',                                      zh: '放弃' },
    noCash:        { en: 'Not enough cash ($5M needed)',              zh: '现金不足（需要$5M）' },
    ...
    oddsTitle:     { en: 'Draw Odds',                                 zh: '抽取概率' },
    oddsPlayer:    { en: 'Player',                                    zh: '球员' },
    oddsPct:       { en: 'Odds',                                      zh: '概率' },
  },
